...
export const PRESETS = {
  none: {
    ...
    values: { beta: 0.4, gamma: 0.03, delta: 0.015, N: 1000, i0: 10, artCoverage: 0 },
  },
  moderate: {
    label: 'Moderate',
    desc: '50% ART coverage with moderate intervention.',
    values: { beta: 0.3, gamma: 0.05, delta: 0.01, N: 1000, i0: 10, artCoverage: 0.5 },
  },
  full: {
    label: 'Full Intervention',
    desc: 'High ART coverage — close to UNAIDS 90-90-90 target.',
    values: { beta: 0.3, gamma: 0.05, delta: 0.01, N: 1000, i0: 10, artCoverage: 0.9 },
  },
};
