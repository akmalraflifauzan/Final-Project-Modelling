...
export const PRESETS = {
  ...
  moderate: {
    label: 'Moderate',
    desc: '50% ART coverage, moderate protection and testing.',
  ...
  full: {
    ...
    desc: 'High ART, protection, and routine testing.',
...
export function effectiveParams(params) {
  const { beta, gamma, delta, N, i0, artCoverage, protectionRate, testingRate } = params;
